// Copyright (c) 2017 The mozocoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("mozocoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("mozocoin-smsg-pow"); // Make this thread recognisable
